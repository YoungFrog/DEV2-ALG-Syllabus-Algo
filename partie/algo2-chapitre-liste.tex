...
\begin{liste}
	...
	\item 
		La version de «\pseudocode{~supprimer~}» avec une position en
...
En \emph{DEV1},
nous n'avons vu que des tableaux statiques,
qui sont créés lors de leur déclaration.
Ici, nous avons besoin de tableaux dynamiques,
créé dans le code
...
Un tableau dynamique sera déclaré puis créé ainsi
	...
	\begin{Pseudocode}
		...
		\LComment{Autres déclarations et instructions}
		\Let tab \Gets \K{nouveau} \K{tableau} [1 à n] de T \RComment n doit avoir une valeur
	\end{Pseudocode}
...
\begin{Exercice}{Rendez-vous}
	...
	\pseudocode{Date} sans paramètre.
\end{Exercice}
