...
%------------------------------------
	...
	de l'état du jeu.
	On vous demande pour chaque d'elles de vérifier, 
	...
	\item
		...
		\item
			...
			Joueur reprendra le nom du joueur à cette position ("A","B" ou "" si la case est vide); 
...
%-----------------------------
	...
	\begin{itemize}
		...
		\item 
			donner le nombre total de mots (plus d'une lettrre) de la grille 
