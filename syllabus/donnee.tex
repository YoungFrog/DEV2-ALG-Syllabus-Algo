...
\begin{Exercice}{Un jeu de poursuite}
	...
	\begin{itemize}
		...
		\item 
			la même méthode «\lda{~jouerTour~}» effectue la même tâche
...
\begin{Exercice}{La course à la case 64}
	...
	lancement du dé est simulé par le module \lda{lancerDé(
...
\begin{Exercice}{Mots croisés}
	...
	\begin{itemize}
		\item 
			...
			\lda{vrai} si la case correspondante de la grille est une
			case noire;
		\item 
...
\begin{Exercice}{Mastermind}
	...
	\lda{k} pions de couleurs, choisie et tenue secrète
...
%
	...
	Le module \lda{jeuMillionaireConsole()} reçoit le
