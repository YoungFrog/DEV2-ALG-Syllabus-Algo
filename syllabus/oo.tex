...
%=======================================
	...
	%============================
		...
		\;
			\LComment{Retourne le nombre de jours dans une représentation JJ/HH:MM:SS}
			\Method{getJour}{}{entier}{
				\Return totalSecondes DIV (3600*24)\;
			}
		\;
			\LComment{Retourne le nombre d'heures dans une représentation JJ/HH:MM:SS}
			\Method{getHeure}{}{entier}{
				\LComment{On doit enlever les jours éventuels}
				\Return (totalSecondes DIV 3600) MOD 24\;
			}
		\;
			\LComment{Retourne le nombre de minutes dans une représentation JJ/HH:MM:SS}
			\Method{getMinute}{}{entier}{
				\LComment{On doit enlever les heures éventuelles}
				\Return (totalSecondes DIV 60) MOD 60\;
			}
		\;
			\LComment{Retourne le nombre de secondes dans une représentation JJ/HH:MM:SS}
		...
		\;
			\Method{différence}{autreDurée~: Durée}{Durée}{
				\Return \KwSty{nouvelle} Durée(valeurAbsolue(totalSecondes - autreDurée.getTotalSecondes()))
			}
		%\;
	...
	%=====================================
		...
		Nous allons utiliser le mot clé \KwSty{nouveau}
		(ou \KwSty{nouvelle} si vous jugez utile d'accorder avec le type)
		...
		\begin{algo}
			\Algo{diffDurée}{}{}{
				\LComment{Les variables sont déclarées/créées}
				\Decl{durée1, durée2}{Durée}	
				durée1 \Gets \KwSty{nouvelle} Durée(3, 4, 49)	\RComment{Les objets sont créés}
				durée2 \Gets \KwSty{nouvelle} Durée(3, 24, 37)	\RComment{Les objets sont créés}
	...
	\begin{itemize}
		...
		\item
			...
			\begin{algo}
				...
				rendezVous \Gets \KwSty{nouvelle} Durée(14, 23, 56)\;
				\Write rendezVous
		...
		\item
			...
			\begin{algo}
				...
				parcours \Gets \KwSty{nouvelle} Durée( 14, 23, 56 )	\RComment{parcours ${\neq}$ rien}
				\If{parcours $\neq$ rien}{
		...
		\item
			...
			(via \lda{\KwSty{nouveau} NomClasse()}).
				...
				\Algo{jeuLièvreTortue}{}{}{
					...
					\While{avancéeTortue < \nbMaxKmTortue{} ET NON lièvreArrivé}{
						...
						\eIf{dé = 6}{
							...
							avancéeTortue \Gets avancéeTortue + 1\;
						}
		...
		%-----------------------------------
			...
			\begin{algo}
				\Algo{jeuLièvreTortue}{}{}{
					...
					\Decl{dé}{Dé}
					\;
					tortue \Gets \KwSty{nouvelle} Tortue()\;
					lièvre \Gets \KwSty{nouveau} Lièvre()\;
					dé \Gets \KwSty{nouveau} Dé()\;
					\;
	...
	%=======================================
		...
		\begin{algo}
			\Algo{jeuLièvreTortue}{}{}{
				...
				jeu \Gets \KwSty{nouveau} LièvreTortue()\;
				jeu.jouer()\;
			}
		\end{algo}
		...
		\begin{algo}
			\Algo{jeuLièvreTortue}{}{}{
				(\KwSty{nouveau} LièvreTortue()).jouer()\;
			}
		\end{algo}
