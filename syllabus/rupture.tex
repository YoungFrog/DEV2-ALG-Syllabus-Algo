...
\begin{algo}
  \Algo{club}{\Par{membres}{Liste de Participant}}{}{
    ...
    \Decl{accumRésultat, nbResultat}{entier}\;
    \Decl{nbMineursTotal}{entier}\;
    \Assign{n}{membres.taille()}\;
    \Assign{i}{0}\;
    \While{i < n }{
      \Assign{saveRef}{membres.get(i).reference}\;
      \Assign{nbMineursTotal}{0}\;
      ...
      \While{i < n ET saveRef = membres.get(i).reference }{
        ...
        \While{i < n ET saveNom = membres.get(i).nom }{
          ...
          \Assign{nbResultat}{nbResultat + 1}\;
          \Assign{i}{i + 1}\;
        }
        \If{mineur }{
          \Assign{nbMineursTotal}{nbMineursTotal + 1}\;
          \Write  saveNom + accumRésultat/nbResultat\;
        }
      }
      \eIf{nbMineursTotal > 0 }{
        \Write  "Nombre total de membres mineurs de ce club : " + nbMineursTotal\;
      }{
