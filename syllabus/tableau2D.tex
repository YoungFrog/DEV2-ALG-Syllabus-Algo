...
% ====================
	...
	%======================
		...
		\Algo{statistiquesVentesSemaine}{}{}
			...
			%\Empty
			\For{jour}{0}{6} \Comment Pour chaque jour de la semaine
	...
	\subsection{Exercices}
		...
		\begin{Exercice}{Case nulle ?}
			...
			\begin{LDA}
				\Entete{estNul}{\Par{tab}{\Array{n $\times$ m}{integers}}, \Par{lg, col}{integers}}{boolean}
			\end{LDA}
		\end{Exercice}
		...
		\begin{Exercice}{Assigner une case}
			...
			\begin{LDA}
				\Entete{assigner}{\Par{tab\InOut}{\Array{n $\times$ m}{integers}}, \Par{lg\In, col\In, val\In}{integers}}{}
			\end{LDA}
		\end{Exercice}
		...
		\begin{Exercice}{Un bord du tableau}
			...
			\begin{LDA}
				\Entete{estBord}{\Par{tab}{\Array{n $\times$ m}{integers}}, \Par{lg, col}{integers}}{boolean}
			\end{LDA}
		\end{Exercice}
		...
		\begin{Exercice}{Un coin du tableau}
			...
			\begin{LDA}
				\Entete{estCoin}{\Par{tab}{\Array{n $\times$ m}{integers}}, \Par{lg, col}{integers}}{boolean}
			\end{LDA}
		\end{Exercice}
...
% ===================
	...
	\begin{Exercice}{Toute une ligne de valeurs non nulles ?}
		...
		\begin{LDA}
			\Entete{lignePleine}{\Par{tab}{\Array{n $\times$ m}{integers}}, \Par{lg}{integer}}{boolean}
		\end{LDA}
