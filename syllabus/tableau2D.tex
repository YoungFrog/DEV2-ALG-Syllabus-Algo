...
% ===================
	...
	En DEV1, nous avons introduit les tableaux à une dimension.
...
% ====================
	...
	%======================
		...
		\Algo{remplirCoins}{}{}
			\Decl{grille}{\Array{3$\times$5}{chaines}}
		...
		\Algo{traiterStock1Jour}{\Par{cpt\InOut}{\Array{7$\times$10}{entiers}}, \Par{jour\In}{entier}}{}
	...
	\subsection{Exercices}
		...
		\begin{Exercice}{Case nulle ?}
			...
			\begin{LDA}
				\Entete{estNul}{\Par{tab}{\Array{n $\times$ m}{entiers}}, \Par{lg, col}{entiers}}{booléen}
			\end{LDA}
		\end{Exercice}
		...
		\begin{Exercice}{Assigner une case}
			...
			\begin{LDA}
				\Entete{assigner}{\Par{tab\InOut}{\Array{n $\times$ m}{entiers}}, \Par{lg\In, col\In, val\In}{entiers}}{}
			\end{LDA}
		\end{Exercice}
		...
		\begin{Exercice}{Un bord du tableau}
			...
			\begin{LDA}
				\Entete{estBord}{\Par{tab}{\Array{n $\times$ m}{entiers}}, \Par{lg, col}{entiers}}{booléen}
			\end{LDA}
		\end{Exercice}
		...
		\begin{Exercice}{Un coin du tableau}
			...
			\begin{LDA}
				\Entete{estCoin}{\Par{tab}{\Array{n $\times$ m}{entiers}}, \Par{lg, col}{entiers}}{booléen}
			\end{LDA}
		\end{Exercice}
...
% ================================================
	...
	%====================================
		...
		\begin{LDA}
			\LComment{Parcours de la diagonale montante d'un tableau carré - version 2 indices}
		...
		\begin{LDA}
			\LComment{Parcours de la diagonale montante d'un tableau carré - version 1 indice}
			\Algo{affichageElémentsDiagonaleMontante}{\Par{tab}{\Array{n $\times$ n}{T}}}{}
				\For{i}{0}{n-1}
		...
		%---------------------------------------
			...
			\begin{LDA}
				...
				\Algo{affichageElémentsLigneParLigne}{\Par{tab}{\Array{n $\times$ m}{T}}}{}
					...
					\Let col \Gets 0
					\Let i \Gets 1
					\While{i $\le$ n*m} \RComment ou "lg $<$ n" 
						\Write tab[lg,col] \RComment On peut faire autre chose qu'afficher
						\Let col \Gets col + 1	\RComment Passer à la case suivante
						\If{col = m} \RComment On déborde sur la droite, passer à la ligne suivante
							\Let col \Gets 0
			...
			\begin{LDA}
				...
				\Algo{chercherElément}{\Par{tab}{\Array{n $\times$ m}{T}}, \Par{élt}{T}}{booléen}
					\Decl {lg, col}{entiers}
					\Decl {trouvé}{booléen}
...
% ===================
	...
	\begin{Exercice}{Toute une ligne de valeurs non nulles ?}
		...
		\begin{LDA}
			\Entete{lignePleine}{\Par{tab}{\Array{n $\times$ m}{entiers}}, \Par{lg}{entiers}}{booléen}
		\end{LDA}
