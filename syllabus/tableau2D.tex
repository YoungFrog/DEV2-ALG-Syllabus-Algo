...
% ====================
	...
	\subsection{Exercices}
		...
		\begin{Exercice}{Case nulle ?}
			...
			\begin{LDA}
				\Entete{estNul}{\Par{tab}{\Array{n $\times$ m}{entiers}}, \Par{ligne, colonne}{entiers}}{booléen}
			\end{LDA}
		\end{Exercice}
		...
		\begin{Exercice}{Assigner une case}
			...
			\begin{LDA}
				\Entete{assigner}{\Par{tab}{\Array{n $\times$ m}{entiers}}, \Par{ligne, colonne, valeur}{entiers}}{}
			\end{LDA}
		\end{Exercice}
