...
% ====================
	...
	%======================
		...
		\Algo{initialiser}{\Par{entiers}{\Array{7$\times$10}{integers}}}{}{
			\Fori{i}{0}{6}{
				\Fori{j}{0}{9}{
					entiers[i,j] \Gets 0\;
				}
		...
		\listing*[linerange=24-26,basicstyle=\footnotesize\vtt]{java}{java/src/main/java/dev2/algo/tab/Exemple2.java}
		\listing*[linerange=28-37,basicstyle=\footnotesize\vtt]{java}{java/src/main/java/dev2/algo/tab/Exemple2.java}
	...
	\subsection{Exercices}
		...
		\begin{Exercice}{Case existe ?}
			...
			ç-à-d qu'elles sont dans le bon intervalle
			($0$ à $n-1$ et $0$ à $m-1$).
